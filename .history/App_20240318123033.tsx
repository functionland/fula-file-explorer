...
const App = () => {
  ...
  const initFula = async (
    ...
    try {
      return fula.init(privateKey_tower, '', bloxAddr, '', true, root_cid);
    } catch (e) {
      console.log(e);
  ...
  useEffect(() => {
    ...
    const privateKey2 = [
      ...
      89, 153, 106, 217, 201, 106, 9, 66, 33, 214, 195, 255, 234, 178, 244, 203,
      112, 62, 91, 140, 55, 179, 10, 208, 210, 177, 111, 61, 46, 73, 148, 14,
      62,
    ];
    // Initialize Fula with your privateKey and dynamically constructed bloxAddr
    const _fulaInit = await initFula(privateKey2.toString(), bloxAddr, rootCid);
