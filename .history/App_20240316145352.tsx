...
const App = () => {
  ...
  const handleLs = async () => {
    try {
      ...
      const bloxAddr = `/dns4/${poolId}.pools.functionyard.fula.network/tcp/40001/p2p/12D3KooWD3nNJtfNgRWhZf6FgFhrq8H7NBhziPAZpqzK1RycjgBt`;

      // Initialize Fula with your privateKey and dynamically constructed bloxAddr
      await fula.init(privateKey, '', bloxAddr, '', true, rootCid);
